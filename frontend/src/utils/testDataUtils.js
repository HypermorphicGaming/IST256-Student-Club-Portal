...
const eventTemplates = {
  social: [
    {
      name: 'Campus Mixer',
      description: 'A relaxed mixer for new and returning members to connect.',
    },
    {
      name: 'Game Night',
      description: 'An informal night of board games, snacks, and conversation.',
    },
    {
      name: 'Club Social',
      description: 'A casual social event with music and light refreshments.',
    },
  ],
  meeting: [
    {
      name: 'Weekly Planning Meeting',
      description: 'A focused planning session for upcoming club activities.',
    },
    {
      name: 'Executive Board Meeting',
      description: 'Leadership meeting to review timelines, tasks, and updates.',
    },
    {
      name: 'Member Check-In',
      description: 'A short meeting to gather feedback and coordinate next steps.',
    },
  ],
  professional: [
    {
      name: 'Resume Workshop',
      description: 'A hands-on session to improve resumes and LinkedIn profiles.',
    },
    { name: 'Career Panel', description: 'A panel discussion with professionals and alumni.' },
    {
      name: 'Networking Night',
      description: 'A professional networking event with guided introductions.',
    },
  ],
}

const rooms = ['SCI 204', 'LIB 118', 'ENG 310', 'STU 105', 'HUM 220', 'BUS 142', 'TECH 016']
...
export const createRandomEvent = () => {
  ...
  const eventCost =
    category === 'social'
      ? pickRandom([0, 5, 10, 12.5, 15])
      : category === 'meeting'
        ? pickRandom([0, 3, 5, 7.5])
        : pickRandom([10, 15, 20, 25, 35])
